...
import { Button as HeroButton, buttonVariants, type ButtonRootProps } from "@heroui/react"
import { tv, type VariantProps } from "@heroui/styles"

const buttonVariantsDef = tv({
...
type ButtonVariants = VariantProps<typeof buttonVariantsDef>

export type ButtonProps = Omit<ButtonRootProps, "className" | "variant" | "size"> &
  ButtonVariants & {
    className?: string
  }
...
function Button({ className, variant = "default", size = "default", ...props }: ButtonProps) {
  return (
    <HeroButton
      ...
      data-size={size}
      className={buttonVariantsDef({ variant, size, className })}
      {...props}
    />
  )
}

export { Button, buttonVariantsDef as buttonVariants }