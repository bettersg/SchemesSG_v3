...
import SchemeContent from "@/components/schemes/scheme-content";
...
const mapToFullScheme = (rawData: FullSchemeData): SearchResScheme => {
  ...
  return {
    ...
    schemeType: Array.isArray(rawData["Scheme Type"]) ? rawData["Scheme Type"] : rawData["Scheme Type"]?.split(', ') || [],
    schemeName: rawData["Scheme"] || "",
    targetAudience: Array.isArray(rawData["Who's it for"]) ? rawData["Who's it for"] : rawData["Who's it for"]?.split(', ') || [],
    agency: rawData["Agency"] || "",
    description: rawData["Description"] || "",
    scrapedText: rawData["scraped_text"] || "",
    benefits: Array.isArray(rawData["What it gives"]) ? rawData["What it gives"] : rawData["What it gives"]?.split(',') || [],
    link: rawData["Link"] || "",
    image: rawData["Image"] || "",
