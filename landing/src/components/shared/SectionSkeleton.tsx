...
const shimmerClass =
  "relative overflow-hidden rounded-lg bg-[#e0eaf5] before:absolute before:inset-0 before:-translate-x-full before:bg-gradient-to-r before:from-transparent before:via-white/50 before:to-transparent before:animate-[shimmer_1.6s_infinite] motion-reduce:before:animate-none"
...
export function HeroSkeleton() {
  return (
    <section className="relative min-h-0 lg:min-h-[100svh] flex items-center bg-[#f0f6ff] px-6 pt-28 pb-16 lg:py-20">
...
export function TestimonialSkeleton() {
  return (
    <section className="bg-[#f7f9fc] py-20 md:py-28 px-6">
...
export function CTASkeleton() {
  return (
    <section className="bg-gradient-to-br from-[#042C53] to-[#185FA5] py-20 md:py-28 px-6">
      <div className="mx-auto max-w-3xl text-center">
        <Block w="320px" h="36px" round className="mx-auto mb-4 max-w-[70%] !bg-white/15" />
        <Block w="460px" h="18px" round className="mx-auto mb-2 max-w-[85%] !bg-white/10" />
        <Block w="380px" h="18px" round className="mx-auto mb-8 max-w-[75%] !bg-white/10" />
        <Block w="180px" h="44px" round className="mx-auto !bg-[#EF9F27]/40" />
      </div>
    </section>
  )
}
