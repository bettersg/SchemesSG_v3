...
export const features = [
  ...
  },
  {
    ...
    description:
      "Answer a few simple questions and we\u2019ll show you which schemes you\u2019re likely eligible for, saving you hours of research.",
    icon: "userCheck" as const,
  },
  {
    title: "Comprehensive Database",
    description:
      "Access over 500 government and community schemes from agencies like MSF, MOH, HDB, CPF, and more\u2014all in one place.",
...
export const stats = [
  { value: 500, suffix: "+", label: "Schemes Indexed" },
  { value: 200, suffix: "+", label: "Agencies Covered" },
]
