...
NEGATIVE_PATTERNS = [
    'banner', 'hero', 'background', 'social', 'facebook', 'twitter',
    'linkedin', 'instagram', 'youtube', 'ad-', 'promo', 'slider',
    'carousel', 'gallery', 'thumbnail', 'avatar', 'profile'
]
...
CLOUDFLARE_INDICATORS = [
    "cloudflare", "challenge", "ray id", "cf-browser-verification",
    "just a moment", "checking your browser", "enable javascript"
]

BOT_PROTECTION_INDICATORS = [
    "err_blocked", "cloudflare", "captcha", "challenge",
    "forbidden", "403", "bot", "blocked_by_client"
]
